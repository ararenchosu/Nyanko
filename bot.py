...
# ここを編集してください
# =====================
BOT_TOKEN = "MTU0NjkzMDQ0MDMwNzIxNjU1Ng.GMf5l-.CPij4g2A6g5kMF1uzfoteoWQv3cPDkCmWKKPhY"
ADMIN_IDS = [
1256574550901133377,  # ここに管理者のDiscord IDを入れる（複数可）
]
...
if __name__ == "__main__":
    if BOT_TOKEN == "MTU0NjkzMDQ0MDMwNzIxNjU1Ng.GMf5l-.CPij4g2A6g5kMF1uzfoteoWQv3cPDkCmWKKPhY":
